      ...
      <div className="bg-white border border-border rounded-2xl overflow-hidden mb-4 shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-end justify-between -mt-10 mb-4">
            <div className="relative">
              <div
                ...
                className="w-20 h-20 rounded-2xl bg-accent-soft border-4 border-white flex items-center justify-center text-xl font-bold text-accent cursor-pointer overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.12)] hover:opacity-90 transition-opacity"
              >
                {user.avatar ? (
              ...
              <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-lg bg-accent border-2 border-white flex items-center justify-center cursor-pointer pointer-events-none">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl border border-border text-[13px] font-medium text-text-2 bg-white cursor-pointer hover:bg-surface-2 transition-colors"
            >
          ...
          {editing && (
            <div className="mb-4 space-y-2">
              <textarea
                ...
                rows={3}
                maxLength={300}
                className="w-full px-3.5 py-2.5 rounded-xl border border-border text-[13px] text-text-2 leading-relaxed outline-none focus:border-accent resize-none font-sans bg-white"
              />
          ...
          <div className="flex items-center gap-5 pt-3 border-t border-surface-2">
            ...
            <div className="ml-auto text-[12px] text-text-3">Član od {joinedDate}</div>
          </div>
        </div>
      </div>

      {/* Tabs */}
      <div className="flex gap-1 mb-4 border-b border-border bg-white rounded-t-xl px-2 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
        {([
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-3 text-[13px] font-medium border-none bg-transparent cursor-pointer border-b-2 -mb-px transition-colors ${
              activeTab === value
        ...
        <div className="space-y-4">
                ...
                <div key={req.id} className="flex items-center gap-3 px-5 py-3 border-b border-surface-2 last:border-b-0">
                  ...
                  <div className="flex gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-lg border border-border text-text-2 text-[12px] bg-white cursor-pointer hover:bg-surface-2"
                    >
                      Odbij
                    </button>
                  </div>
          ...
          <div className="bg-white border border-border rounded-2xl overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
            ...
            {!friends?.length ? (
              ...
              friends.map((friend) => (
                <div key={friend.id} className="flex items-center gap-3 px-5 py-3 border-b border-surface-2 last:border-b-0 hover:bg-surface-2 transition-colors">
                  <div className="w-9 h-9 rounded-full bg-accent-soft flex items-center justify-center text-[11px] font-bold text-accent overflow-hidden border border-border shrink-0">
                    {friend.avatar
